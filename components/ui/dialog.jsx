  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-(--radius-md) border border-default bg-card text-card-foreground p-6 shadow-xl outline-none",
          className
        )}
        {...props}
      />
